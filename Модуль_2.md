...
## Задание 1 (нужно добавить скриншоты с клиента)
...
Поясняю команду на пальцах: сначала пишем IP-адрес смотрящий во внутреннюю сеть, порт HTTP, дальше IP-адрес смотрящий в сторону ISP, порт по варианту (в нашем случае 8080)
